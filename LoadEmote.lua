        ...
        local emoteScriptString = [[
            ...
            loadstring(game:HttpGet("https://raw.githubusercontent.com/ozaghazali/AsuHub/refs/heads/main/Notify.lua"))()
            ...
            local function fetchAllAnimations()
                ...
                local success, result = pcall(function()
                    local jsonContent = game:HttpGet("https://raw.githubusercontent.com/ozaghazali/AsuHub/refs/heads/main/AnimationSniper.json")
            ...
            local function onCharacterAdded(character)
             ...
             if getgenv().autoReloadEnabled and getgenv().lastPlayedAnimation then
                ...
                getgenv().Notify({
                    Title = 'AsuHub | Auto Reload Animation',
            ...
            if UserInputService.TouchEnabled and not UserInputService.KeyboardEnabled then
                loadstring(game:HttpGet("https://raw.githubusercontent.com/ozaghazali/AsuHub/refs/heads/main/Emote.lua"))()
                getgenv().Notify({
                    Title = 'AsuHub | Emote Mobile',
